...
<?php echo e($assist->artisanCommand('install:api --passport')); ?>
...
___SINGLE_BACKTICK______SINGLE_BACKTICK______SINGLE_BACKTICK___bash
<?php echo e($assist->artisanCommand('passport:client')); ?>              # Authorization code
<?php echo e($assist->artisanCommand('passport:client --public')); ?>     # PKCE (no secret)
<?php echo e($assist->artisanCommand('passport:client --client')); ?>     # Client credentials
<?php echo e($assist->artisanCommand('passport:client --personal')); ?>   # Personal access tokens
<?php echo e($assist->artisanCommand('passport:client --device')); ?>     # Device authorization
___SINGLE_BACKTICK______SINGLE_BACKTICK______SINGLE_BACKTICK___
...
___SINGLE_BACKTICK______SINGLE_BACKTICK______SINGLE_BACKTICK___bash
<?php echo e($assist->artisanCommand('passport:purge')); ?>              # Purge revoked & expired
<?php echo e($assist->artisanCommand('passport:purge --revoked')); ?>    # Only revoked
<?php echo e($assist->artisanCommand('passport:purge --expired')); ?>    # Only expired
___SINGLE_BACKTICK______SINGLE_BACKTICK______SINGLE_BACKTICK___
...
<?php /**PATH /home/masqueradis/Laravel/Back/storage/framework/views/edc7fd2bd926b370186d21774d609333.blade.php ENDPATH**/ ?>